...
class ProjectProject(models.Model):
	...
	site_engineer1 = fields.Many2one('hr.employee', 'Site Engineer 1', domain="[('user_category', '=', 'site_eng')]")
	site_engineer2 = fields.Many2one('hr.employee', 'Site Engineer 2', domain="[('user_category', '=', 'site_eng')]")
	site_engineer3 = fields.Many2one('hr.employee', 'Site Engineer 3', domain="[('user_category', '=', 'site_eng')]")
