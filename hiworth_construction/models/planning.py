...
class MasterPlanLine(models.Model):
    ...
    # @api.multi
    # def write(self, vals):
    #     res = super(MasterPlanLine, self).write(vals)
...
class ImageGallery(models.Model):
    ...
    measure_id = fields.Selection(
        [('m_m_p', 'Morning Meeting Photo'), ('wsp', 'Work Start Photo'), ('wip', 'Work In Progress Photo'),
         ('aftl', 'Work After Lunch Photo')], 'Types')
    ...
    @api.multi
    def add_image(self):
        view_ref = self.env['ir.model.data'].get_object_reference('hiworth_construction',
                                                                  'view_ir_attachment_form_view_image_new')
