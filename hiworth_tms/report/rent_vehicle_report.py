...
class VehicleRentVehicleExpenseWizard(models.TransientModel):
    ...
    def get_details(self):
                ...
                for dicts in lst:
                    ...
                    if item_copy == dicts['veh_id']:
                        if item_copy:
                            ...
                            old_load = dicts['loads']
                            new_loadss = old_load + loads
                            dicts['loads'] = new_loadss
                            ...
                            if rec.night_shift == True:
                              ...
                              new_abs = old_abs - 1
                            dicts['absent_days'] = dicts['no_days'] - old_w1days
                            old_rent_total = dicts['rent_total']
                            ...
                            old_rent = dicts['rent_total']

                            new_rent = t_rent + old_rent

                            dicts['rent_total'] = new_rent
                            row_t = new_rent + new_amt
        ...
        for vals in lst:
            ...
            vehicle_number = vals['vehicle_no']
            if vehicle_number.is_a_rent == True:
                vals['absent_days'] = 0
        return lst
